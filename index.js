//to run this code--open terminal --> cd CarRacingGame-main-->http-server
//if above one is not working means u havent installed http-server so install it globally-->npm install -g http-server
